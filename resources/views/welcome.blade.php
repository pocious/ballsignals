...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-4">
                        ...
                        <div id="tip-{{ $tip->id }}" class="tip-card-wrap rounded-2xl overflow-hidden border">
                            ...
                            <a href="{{ route('tips.show', $tip) }}" class="block px-4 pt-3.5 pb-3">
                                ...
                                <div class="flex items-start justify-between gap-2 mb-1.5">
                                    ...
                                    @else
                                    <span class="tip-badge-pending inline-flex items-center gap-0.5 text-[8px] px-1 py-px rounded-full font-medium flex-shrink-0 mt-0.5">
                            ...
                            {{-- Tab bar --}}
                            <div class="tip-tab-border grid grid-cols-3" style="border-top:1px solid rgba(128,128,128,0.15)">
                                <a href="{{ route('tips.show', $tip) }}"
                                   class="tip-tab-analysis flex items-center justify-center gap-1.5 py-2 text-[11px] font-semibold text-green-600 dark:text-green-400">
                                ...
                                <a href="{{ route('premium') }}"
                                   class="tip-tab-vip flex items-center justify-center gap-1.5 py-2 text-[11px] font-semibold text-yellow-600 dark:text-yellow-400"
                                ...
                                <button
                                    ...
                                    class="tip-tab-share flex items-center justify-center gap-1.5 py-2 text-[11px] font-semibold w-full text-gray-500 dark:text-gray-400">
                                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {{-- ── Premium CTA ── --}}
    <a href="{{ route('premium') }}"
       class="premium-cta mt-6 flex items-center justify-between gap-3 px-5 py-4 rounded-2xl
