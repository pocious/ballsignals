                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div id="tip-{{ $tip->id }}" class="tip-card-wrap rounded-2xl overflow-hidden border">
                            ...
                            {{-- Tab bar --}}
                            <div class="tip-tab-border grid grid-cols-3 border-t">
                                ...
                                <a href="{{ route('premium') }}"
                                   class="tip-tab-vip tip-tab-border flex items-center justify-center gap-1.5 py-2 text-[11px] font-semibold text-yellow-600 dark:text-yellow-400 border-l border-r">
