                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div id="tip-{{ $tip->id }}" class="tip-card-wrap rounded-2xl overflow-hidden border">
                            ...
                            {{-- Tab bar --}}
                            <div class="tip-tab-border grid grid-cols-3 border-t border-gray-100">
                                <a href="{{ route('tips.show', $tip) }}"
                                   class="tip-tab-analysis flex items-center justify-center gap-1.5 py-2 text-[11px] font-semibold text-green-600 dark:text-green-400 bg-green-50">
                                ...
                                <a href="{{ route('premium') }}"
                                   class="tip-tab-vip tip-tab-border flex items-center justify-center gap-1.5 py-2 text-[11px] font-semibold text-yellow-600 dark:text-yellow-400 bg-yellow-50 border-l border-r border-gray-100">
                                ...
                                <button
                                    ...
                                    class="tip-tab-share flex items-center justify-center gap-1.5 py-2 text-[11px] font-semibold w-full text-gray-500 dark:text-gray-400 bg-gray-50">
                                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
